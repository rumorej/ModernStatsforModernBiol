...
The function below is used to determine codon bias within EACH amino acid.
...
The function below is used to determine codon bias in Mtb dataset among ALL amino acids.
...
With respect to the mtb data we explored, Ile and Phe appear to have the strongest codon bias.
